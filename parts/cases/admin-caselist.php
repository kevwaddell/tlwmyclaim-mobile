<tbody>
	...
	//echo '<pre class="debug">';print_r($case_status);echo '</pre>';
  	...
  	<tr class="<?php echo ($case_status == "open") ? 'success':'warning'; ?>">
	  	...
	  	<td><a href="<?php the_permalink(); ?>" class="btn btn-block btn-<?php echo ($case_status == "open") ? 'success':'warning'; ?>"><span class="sr-only">View case details</span><i class="fa fa-angle-right"></i></a></td>
  	</tr>
  	<?php endwhile; ?>
</tbody>